...
\ustcsetup{
  title           = {毕业论文中文题目},
  title*          = {English title of the graduation thesis},
  author          = {姓名},
  author*         = {},
  % ===== 河科大封面字段（可按需填写） =====
  clc             = {\hspace{6em}},
  ...
  degree-category* = {Doctor of Engineering},
  % 专业学位填写（可留空）
  co-supervisor    = {},
  professional-field  = {},
  professional-field* = {},
...
\usepackage{siunitx}
  ...
  % 当前样式按 GB/T 7714—2005 顺序编码制著录。
  % 拼音姓名建议写成 `Qian, Xuesen`，输出为 `Qian Xuesen`；
  % 如需缩写，可写成 `Qian, {XS}`，输出为 `Qian XS`。
